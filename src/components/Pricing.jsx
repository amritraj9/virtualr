                    ...
                    <div className='p-10 border border-neutral-700 rounded-xl'>
                        <p className='text-4xl mb-8'>
                            ...
                            {option.title ==="Pro"&& (<span className='bg-gradient-to-r from-orange-500 to-red-400 text-transparent bg-clip-text text-xl mb-4 ml-2'>
                                (Most Popular) {/*this all thing is done to just show the most popular branding and ===is used to check if title is pro  */}
                            </span>)}
                        </p>
                        <p className='mb-8 '>
                            <span className='text-5xl mt-6 mr-2'>
                                {option.price}
                                <span className='text-neutral-400 tracking-tight'>/Month</span>{/*we are using so much of span because its takes only the limited space in which it is spanned */}
                            </span>
                        </p>
                        <ul>
